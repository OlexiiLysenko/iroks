 ...
 <br><br><br><br><br><br>
   ...
   <div class="container">
	   <div class="row">
          ...
          <li class="active">
            <a id="Ryasne-1" class="activeTab" href="http://iroks.com.ua/Rooms8.php#Jump">вул. О. Бальзака, 25</a>
          </li>
		   	</ul>
		   	<br>
		   	<p class="street-name">
    ...
    <br><br><br>
          <b style="color: red;">Увага!!! Будинок здано в експлуатацію, всі квартири розпродано! ЗАЛИШИЛАСЯ лише одна 2-кімнатна квартира!</b>
    <br>
          За будь-якою інформацією стосовно даної квартири, будь-ласка, звертайтесь до наших менеджерів за номерами тел. 
          <a  href="http://iroks.com.ua/Rooms8.php#Jump1">внизу сторінки</a>.
    <br><br><br>
    </p>
        ...
        <p class="street-name">
          ...
          <br>
          Загальна площа: від 50,40 кв.м.
          <br>
          Житлова кімната 1: 12,2 кв.м.
          <br>
          Житлова кімната 2: 17,4 кв.м.
          <br>
          Кухня: 8,2 кв.м.
          <br>
          Ванна кімната:  3,4 кв.м.
          <br>
          Коридор: 5,9 кв.м.
          <br>
          Лоджія:  2,6 кв.м.
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="thumbnail">
          <a class="fancybox" rel="group" href="images/01_бальзака.jpg" title="1-кімнатна квартира"><img src="images/01_бальзака.jpg" style="height: 270px;" alt=""></a>
