     ...
     <div class="row">
      <div class="container">
        <ul class="nav nav-tabs">
          <li class="active">
            <a id="Ternopilska" class="activeTab" href="http://iroks.com.ua/Shareholders.php#Jump">Повідомлення про збори</a>
          </li>
          <li>
            <a id="Ryasne-2" href="http://iroks.com.ua/Shareholders2.php#Jump">Документи загальних зборів</a>
          </li>
          <li>
...
<!-- Inserting Documents via PHP -->
   <?php
            $documents = mysqli_query($connection, "SELECT * FROM `documents` WHERE document_id = 9 ORDER BY pubdate DESC;");
