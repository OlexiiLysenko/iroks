...
<div class="container">
 ...
 <div class="container" style="margin-top: 0px;">
      <div class="row">
        ...
        <img src="images/Building_01.jpg" class="img-responsive img-rounded" alt="Responsive image" style="width: 1700px; height: auto;">
   </div>
        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 text-center"></div>
      </div>
 </div>    
  
        <h1>Чому житло купують саме у нас?</h1>
