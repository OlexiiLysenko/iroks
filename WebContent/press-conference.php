       ...
       <div class="parallax-inner ">
        ...
        <div class="row" style="margin-top: 60px; opacity: 0.8;">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center newshead">
            ...
            <h1>ПРЕСС-КОНФЕРЕНЦІЇ</h1>
            <p>
             <b>Найсвіжіші конференції</b> 
           </p>
         </div> 
       </div>
            ...
            <div class="container-fluid">
             <td>
              ...
              <div class="row">
                <br> <br>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center"> 
                  <h1 style="color:#3ca1e1;">Отримайте офіційні відповіді на важливі питання</h1><br><br><br><br>
                </div>
              </div>
            </td>
          </div>
              ...
              <div class="row news">
               ...
               <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <p class="text-justify column-right"> 
                  ...
                  <br>
                  <a href="/article_press-conference.php?id=<?php echo $art['id']; ?> " style="color: #3879BF;"> читати далі</a>
                </p>
