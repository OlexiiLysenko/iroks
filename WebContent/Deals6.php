     ...
     <div class="row">
      <div class="container">
        <ul class="nav nav-tabs">
         ...
         <!--  <li class="active">
            <a id="License" class="activeTab" href="http://iroks.com.ua/Deals6.php#Jump">вул. Величковського, 62</a>
          </li> -->
          <li>
...
<!-- Inserting Documents via PHP -->
   <?php
            $documents = mysqli_query($connection, "SELECT * FROM `documents` WHERE document_id = 14 ORDER BY title;");
