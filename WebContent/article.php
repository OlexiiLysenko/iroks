              ...
              <!-- NO_CONTENT FOUND --> 
                  ...
                  <div class="col-xs-10 col-sm-10 col-md-8 col-lg-8 text-center">
                        ...
                        <!--  Main TEXT of the No_content -->
                             <p> 
                              <h1>Вибачте, даної статті у розділі "Новини" не знайдено. Гадаємо, вона загубилася десь у Всесвітньому просторі...</h1>
                               <br>
                              
                               <a href="http://iroks.com.ua/News.php" class="btn btn-primary">Всі новини</a>
                        </p>
                  ...
                  <div class="container" style="margin-top: 0px;">
                    ...
                    <hr>
                        <p class="text-left" style="color:#3ca1e1; margin-left: 10px;">Cтаття має: <?php echo $art['views']; ?> переглядів
                          <a id="btn-news" href="http://iroks.com.ua/News.php" class="btn btn-primary text-right">Всі новини</a>
                        </p>
                    <hr>
