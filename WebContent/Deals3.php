     ...
     <div class="row">
      <div class="container">
        <ul class="nav nav-tabs">
          <li class="active">
            <a id="Deals" class="activeTab" href="http://iroks.com.ua/Deals3.php#Jump">вул. Тернопільська, 42</a>
          </li>
          <li>
...
<!-- Inserting Documents via PHP -->
   <?php
            $documents = mysqli_query($connection, "SELECT * FROM `documents` WHERE document_id = 2 ORDER BY title;");
