 ...
 <br><br><br><br><br><br>
   ...
   <div class="container">
	   <div class="row">
          ...
          <li class="active">
            <a id="Ryasne-1" class="activeTab" href="http://iroks.com.ua/Rooms5.php#Jump">вул. Шевченка, 418</a>
          </li>
          <li>
    ...
    <br><br><br>
	   ...
	   <div class="row">
	   	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
		   	<div class="thumbnail">
          <a class="fancybox" rel="group" href="images/Shevchenka_418_3pov_1k_02.png" title="1-кімнатна квартира"><img src="images/Shevchenka_418_3pov_1k_02.png" style="height: 270px;" alt=""></a>
          
			</div>
	   	</div>
	   	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
		   	<div class="thumbnail">
		   		 <a class="fancybox" rel="group" href="images/Shevchenka_418_3pov_1k_01.png" title="2-кімнатна квартира"><img alt="" src="images/Shevchenka_418_3pov_1k_01.png" style="height: 270px;" alt=""></a>
			</div>
    ...
    <br><br><br>
     ...
     <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="thumbnail">
          <a class="fancybox" rel="group" href="images/Shevchenka_418_2k_01.png" title="2-кімнатна квартира"><img src="images/Shevchenka_418_2k_01.png" style="height: 270px;" alt=""></a>
          
      </div>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="thumbnail">
           <a class="fancybox" rel="group" href="images/Shevchenka_418_2k_02.png" title="2-кімнатна квартира"><img alt="" src="images/Shevchenka_418_2k_02.png" style="height: 270px;" alt=""></a>
      </div>
      </div>
