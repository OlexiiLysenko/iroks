      ...
      <div class="container">
        <ul class="nav nav-tabs">
         <!--  <li>
          ...
          <li class="active">
            <a id="Deals" class="activeTab" href="http://iroks.com.ua/Deals1.php#Jump">вул. Шевченка, 418-418a</a>
          </li>
          <!-- <li>
...
<!-- Inserting Documents via PHP -->
   <?php
            $documents = mysqli_query($connection, "SELECT * FROM `documents` WHERE document_id = 7 ORDER BY title;");
    ...
    <!-- Add Documents BEGINNING-->
        ...
        <br>
                ...
                <!-- echo mb_substr(strip_tags($art['text']), 0, 250, 'utf-8') . '...';  -->
        <br>
        </div>
        </div>
