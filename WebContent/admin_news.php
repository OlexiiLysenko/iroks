...
// including all actions 
 include ( "admin_news_actions.php");
                              ...
                              // uploading an image to database and to uploads folder                     
                                  ...
                                  if($upload){
                                    $articles->image10 = $name;
                                     ...
                                     $articles_edit->categorie_id = 3;
                                     R::store( $articles_edit );
                           ?>
                                      <script type="text/javascript"> 
                                        alert ( " УРА!!! Ви щойно змінили існуючу Новину.Щиро дякуємо Вам!" );
                                     </script> 
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="admin_news.php">Новини</a></li>
  ...
  if ($action == "edit")
        {
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Редагувати Новину</h4>
              </div>
...
?>
            ...
            <!-- Latest Users -->
               <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                  <h3 class="panel-title">Всі новини</h3>
                </div>
                <div class="panel-body">
          ...
          ?>
                        ...
                        <tr>
                          ...
                          <td><a href = "admin_news.php?action=edit&id=<?php echo $art['id']; ?>" class="btn btn-primary">Редагувати</a></td>
                          <td><a href = "admin_news.php?action=delete&id=<?php echo $art['id']; ?>" class="btn btn-danger">Видалити</a></td>
                        </tr>
